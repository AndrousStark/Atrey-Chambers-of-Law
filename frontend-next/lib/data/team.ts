...
export const TEAM_MEMBERS: TeamMember[] = [
  {
    ...
    bio: [
      ...
      'A prolific legal scholar, he has authored 3 books — including "Law of Witnesses" with a foreword by Hon\'ble Mr. Justice T.S. Thakur — published 50+ articles in leading legal journals, made over 50 appearances on national television channels including Rajya Sabha TV, Sansad TV, and APN News, and delivered 50+ guest lectures and appearances in different Universities and other platforms. He has more than 200 reported judgments to his credit.',
    ...
    achievements: [
      ...
      'Published 50+ articles in leading legal journals and national newspapers',
      '50+ television appearances as legal expert on national channels',
      '50+ guest lectures and appearances in different Universities and other platforms',
    ...
    stats: [
      { value: 'Since 1997', label: 'Legal Practice' },
      { value: 'AoR', label: 'Supreme Court' },
      { value: '5000+', label: 'Cases Handled Successfully', numericValue: 5000 },
      { value: '50+', label: 'Articles Published', numericValue: 50 },
      { value: '50+', label: 'TV Appearances', numericValue: 50 },
      { value: '50+', label: 'Guest Lectures & University Appearances', numericValue: 50 },
      { value: '200+', label: 'Reported Judgments', numericValue: 200 },
    ],
    isAttorney: true,
  },
  {
