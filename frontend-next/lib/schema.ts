...
export function generateOrganizationSchema() {
  return {
    ...
    image: LOGO_URL,
    description:
      'Atrey Chambers of Law LLP is a premier Indian law firm founded and headed by Dr. Abhishek Atrey (Abhishek Atrey), LL.D., Advocate-on-Record (AOR), Supreme Court of India. Dr. Atrey brings distinguished practice since 1997 with 5000+ cases handled successfully across 32 practice areas including Constitutional Law, Environmental Law, Government Litigation, Criminal Law, Corporate Law, and Arbitration. More than 50 articles published and more than 200 reported judgments. Advocate Abhishek Atrey is a leading Supreme Court practitioner, constitutional law expert, and former Standing Counsel for the Government of Uttarakhand.',
    foundingDate: '1997',
    founder: {
      '@type': 'Person',
      ...
      description: 'Dr. Abhishek Atrey (Mr. Abhishek Atrey), LL.D., Advocate-on-Record, Supreme Court of India. Father of Mr. Aniruddh Atrey. Husband of Mrs. Ambika Atrey. Distinguished legal practice since 1997.',
    },
    address: {
      '@type': 'PostalAddress',
      streetAddress: '32 & 33, 4th Floor, C-Block, Technopark, Plot No.5',
...
export function generateAttorneySchema() {
  return {
    ...
    jobTitle: 'Founder & Managing Partner, Advocate-on-Record',
    description: 'Dr. Abhishek Atrey (Abhishek Atrey / Mr. Abhishek Atrey / Mr. Atrey), LL.D., is the Founder & Managing Partner of Atrey Chambers of Law LLP and a designated Advocate-on-Record (AOR) at the Supreme Court of India since 2006. Abhishek enrolled with the Bar Council of Delhi in 1997 and has distinguished legal practice since 1997 with 5000+ cases handled successfully. More than 50 articles published and more than 200 reported judgments. Dr. Abhishek Atrey is the father of Mr. Aniruddh Atrey (Associate at the firm) and husband of Mrs. Ambika Atrey (Senior Partner). Atrey is a leading constitutional law expert, environmental law authority, and former Standing Counsel for the Government of Uttarakhand. Mr. A. Atrey currently serves as Senior Panel Counsel for CAQM and Panel Counsel for Association of Indian Universities (AIU) and Commission for Air Quality Management (CAQM).',
    ...
    step: [
      {
        ...
        text: 'Schedule a consultation with an Advocate-on-Record (AOR) to discuss your case. Contact Atrey Chambers at +91 120 4587083.',
      },
      {
        '@type': 'HowToStep',
        position: 2,
