...
// Toast and ConfirmDialog provided by shared CmsToastProvider + CmsConfirmDialog

// Loading state provided by shared CmsLoadingState component
...
function ClientsPageInner() {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {/* Loading State */}
      {loading && <CmsLoadingState text="Loading clients..." />}
