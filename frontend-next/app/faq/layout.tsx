...
export const metadata: Metadata = {
  ...
  description: 'Find answers to common legal questions from Atrey Chambers of Law LLP. Dr. Abhishek Atrey\'s (Mr. Abhishek Atrey / Mr. Atrey / Abhishek / Atrey) team explains Supreme Court practice, PIL filing procedures, bail applications, divorce proceedings, environmental complaints at NGT, and more. Abhishek Atrey\'s 29+ years of experience informs every answer. Consult Dr. Atrey, father of Mr. Aniruddh Atrey, for detailed legal guidance.',
