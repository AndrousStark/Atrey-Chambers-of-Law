    ...
    <>
      ...
      <main className="pt-28 md:pt-36 pb-0 bg-cream min-h-screen">
        ...
        <div className="mx-auto max-w-7xl px-4 md:px-10 mb-16">
          ...
          >
            <a href={assetPath("/our-team/abhishek-atrey")} className="group rounded-lg border border-gold/20 bg-white p-6 text-center hover:shadow-lg hover:border-gold/40 transition-all">
            ...
            <a href={assetPath("/our-team/ambika-atrey")} className="group rounded-lg border border-gold/20 bg-white p-6 text-center hover:shadow-lg hover:border-gold/40 transition-all">
            ...
            <a href={assetPath("/our-team/aniruddh-atrey")} className="group rounded-lg border border-gold/20 bg-white p-6 text-center hover:shadow-lg hover:border-gold/40 transition-all">
              <div className="w-32 h-40 rounded-xl mx-auto mb-4 overflow-hidden border-2 border-gold/20 group-hover:border-gold/50 transition-colors shadow-sm">
